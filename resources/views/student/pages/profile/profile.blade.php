            ...
            <div class="container-fluid m-0 p-0">
                ...
                <div class="row bg-white ml-2 mr-2">
                            ...
                            <div class="card-body">
                                <div class=" text-center">
                                    @if ($student->picture != null)
                                        ...
                                        @if (file_exists(public_path($path)))
                                            <img src="{{ asset($student->picture) }}" class="profile-card-img"
                                                class="w-50">
                                        @else
                                            <img src="{{ asset('assets/images/ico/Square-white.jpg') }}"
                                                class="profile-card-img" class="w-50">
                                        @endif
                                    @else
                                        <img src="{{ asset('assets/images/ico/Square-white.jpg') }}"
                                            class="profile-card-img" class="w-50">
                                    ...
                                    <a href="{{ route('student.profile') }}"
                                        class="schedule-btn w-100 mt-3 decoration-none">Edit Profile</a>
                                </div>
                                <div class="col-md-12">
                                    <hr>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-9 m-0 p-0">
                                        ...
                                        <p class="paragraph-text3" style="line-height: 0;">{{ $student->city }},
                                            {{ $student->country }}</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-9">
                        @if ($classes === 3)
                            <div class="card "
                                style="background-image: url('{{ asset('assets/images/ico/bg-prfile1.png') }}');background-position: center;border-radius: 8px;">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-7 text-white">
                                            <div class="text mt-5 ml-2">
                                                ...
                                                <p
                                                    ...
                                                    Congratulation {{ $student->first_name }} , you have completed your 3
                                                    classes we have a gift for you.
                                                </p>
                                        ...
                                        <div class="col-md-5  m-0 p-0">
                                            <div class="home-image">
                                                <img src="{{ asset('assets/images/ico/gift1.png') }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    @if ($tutor->picture != null)
                                                        <img src="{{ asset($tutor->picture) }}" class=" profile-img"
                                                            alt="" style="height:70px; width:70px;">
                                                    @else
                                                        <img src="{{ asset('assets/images/ico/Square-white.jpg') }}"
                                                            alt="" class="profile-img " style="width:70px;height:70px;">
                                                    @endif
                                                </div>
                                                <div class="col-md-5 pl-0 pt-1">
                                                    <p class=" mb-0"> <small> {{ $tutor->first_name }}
                                                            {{ $tutor->last_name }} </small> </p>
                                                    <div class="star-icos">
                                                        <small>
                                                            @if ($tutor->rating == 1)
                                                    ...
                                                    <p class="mb-0"> <small><img
                                                                src="{{ asset('assets/images/ico/location-pro.png') }}"
                                                                alt="" class="">
                                                            {{ $tutor->city != null ? $tutor->city . ' , ' : '---' }}
                                                            {{ $tutor->country != null ? $tutor->country : '---' }}</small>
                                                    </p>
                                                </div>
                                                <!-- <div class="col-md-4">
