...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                    ...
                                    <a class="nav-link" id="v-pills-Verification-tab" data-toggle="pill"
                                    ...
                                    <div class="tab-pane fade active show chee" id="v-pills-General" role="tabpanel"
                                        ...
                                        <form action="{{ route('tutor.profile.update', [$tutor->id]) }}"
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-12">
                                                    <label for="exampleName" class="heading-fifth mb-0">Tutor Profile
                                                        Picture</label>
                                                ...
                                                <div class="col-md-12 my-3">
                                                    <label for="exampleName" class="heading-fifth mb-0">Phone
                                                        Number</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label for="exampleName"
                                                                class="heading-fifth mb-0">Language</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="exampleName"
                                                                class="heading-fifth mb-0">Gender</label>
                                                ...
                                                <div class="col-md-6 mt-3">
                                                    <div class="form-group">
                                                        <label for="exampleName" class="heading-fifth mb-0">Describe your
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    <button class="schedule-btn" id="general_save"
                                        ...
                                        <form action="{{ route('tutor.profile.edu', [$tutor->id]) }}" method="POST"
                                            ...
                                            @if (count($tutor->education) == 0)
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="exampleText" class="m-0 heading-fifth">Major
                                                            Subject</label>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-6 instituteList">
                                                        <label for="exampleText"
                                                            class="m-0 heading-fifth">Institute</label>
                                                        <select name="institute[]" id="institutes_list"
                                                            class="form-select form-select-lg mb-3"
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="exampleText" class="m-0 heading-fifth">Graduation
                                                            Year</label>
                                                        <!-- <input type="date" name="graduate_year[]" class=" yearpicker form-control"> -->

                                                        <select name="graduate_year[]" id=""
                                                            class="yearpicker form-select">
                                            ...
                                            @elseif( count($tutor->education) > 0)
                                                ...
                                                @foreach ($tutor->education as $edu)
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class=" col-md-4">
                                                            <label for="exampleText"
                                                                class="mb-0 heading-fifth">Degree</label>
                                                            <select name="degree[]" onchange="checkLevel(this)"
                                                                class="form-select form-select-lg mb-3" id="degreee">
                                                                <option value="Degree"> Degree</option>
                                                                @foreach ($degrees as $degree)
                                                                    <option value="{{ $degree->id }}"
                                                                        {{ $edu->degree_id == $degree->id ? 'selected' : '' }}>
                                                                        {{ $degree->name }} </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class=" col-md-4">
                                                            <label for="exampleText" class="mb-0 heading-fifth">Major
                                                                Subject</label>
                                                            <select name="major[]" class="form-select form-select-lg mb-3">
                                                                <option value="">Majors</option>
                                                                @foreach ($subjects as $subject)
                                                                    <option value="{{ $subject->id }}"
                                                                        {{ $edu->subject_id == $subject->id ? 'selected' : '' }}>
                                                                        {{ $subject->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class=" col-md-4">
                                                            <label for="exampleText" class="mb-0 heading-fifth">Sudent
                                                                Grade</label>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="instituteList col-md-6">
                                                            <label for="exampleText"
                                                                class="mb-0 heading-fifth">Institute</label>
                                                            <select name="institute[]" id="institutes_list"
                                                                class="form-select form-select-lg mb-3"
                                                                aria-label=".form-select-lg example">
                                                                <option value="Institute">Institute</option>
                                                                @foreach ($institutes as $institute)
                                                                    <option value="{{ $institute->id }}"
                                                                        {{ $edu->institute_id == $institute->id ? 'selected' : '' }}>
                                                                        {{ $institute->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class=" col-md-6">
                                                            <label for="exampleText" class="mb-0 heading-fifth">Completion
                                                                Date</label>
                                                            <!-- <input type="date" name="graduate_year[]" class=" yearpicker form-control" value="{{ $edu->year }}"> -->
                                                            <select name="graduate_year[]" id=""
                                                                class="yearpicker form-select">

                                                                <option value="{{ $edu->year }}" disabled selected>
                                                                    {{ $edu->year }}</option>
                                                                <option value="2000">2000</option>
                                                                <option value="2001">2001</option>
                                                                <option value="2002">2002</option>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-12">
                                                            <input type="file" class="dropify" name="upload[]"
                                                                data-default-file="{{ asset($edu->docs) }}">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-12">
                                                    <a class="extra-fields-customer cust_link" href="javascript::void(0)">+
                                                        Add more degrees </a>
                                            ...
                                            <div class="col-md-12 mt-3">
                                                <button class="schedule-btn" id="educational_save"
                                                    style="width: 180px;float:right;font-size: 14px;" type="submit"
                                                    id="edu2">Save Changes</button>
                                                <button type="button" role="button" type="button" id="educational_loading"
                                                    disabled class="btn btn-primary mb-4 mr-2"
                                                    style="width: 180px;float:right; display:none">
                                                    <i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"></i> <span
                                                        class="sr-only">Loading...</span> Processing </button>
                                    ...
                                    <div class="tab-pane fade chee" id="v-pills-Professional" role="tabpanel"
                                        ...
                                        <form action="{{ route('tutor.profile.profession', [$tutor->id]) }}"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="element">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label for="exampleText"
                                                                        class="mb-0 heading-fifth">Organization</label>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label for="exampleText"
                                                                        class="mb-0 heading-fifth">Designation</label>
                                                                ...
                                                                <div class="col-md-8 mt-2 mb-3">
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        <label class="custom-control-label"
                                                                            for="working">Currently Working? </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="element">
                                                                ...
                                                                <div class="row my-3">
                                                                    <div class=" col-md-6">
                                                                        <label for="exampleText"
                                                                            class="mb-0 heading-fifth">Starting
                                                                            Year</label>
                                                                        <!--<input type="date"
                                                                            value="{{ $profession->start_date ?? '' }}"
                                                                            class="form-control" name="degree_start[]"
                                                                            placeholder="Starting date" value="">-->
                                                                        <select name="degree_start[]"
                                                                            class="yearpicker  form-select">
                                                                            <option value="{{ $profession->start_date }}"
                                                                                selected disable>
                                                                                {{ $profession->start_date }}</option>
                                                                            <option value="2000">2000</option>
                                                                            <option value="2001">2001</option>
                                                                            <option value="2002">2002</option>
                                                                            <option value="2003">2003</option>
                                                                    ...
                                                                    <div class=" col-md-6" id="proEnd">
                                                                        ...
                                                                        <select name="degree_end[]"
                                                                            class="yearpicker form-select">
                                                                            <option value="{{ $profession->end_date }}"
                                                                                selected disable>
                                                                                {{ $profession->end_date }}</option>
                                                                    ...
                                                                    <div class="col-md-6 Cwork">
                                                                        <label for="exampleText"
                                                                            class="mb-0 heading-fifth">Ending Year</label>
                                                                        <input type="text" value="Currently Working "
                                                                            disabled>
                                                                    </div>
                                                                    <div class="col-md-8 mt-2 mb-3">
                                                                        <div class="custom-control custom-checkbox">
                                                                            <input type="checkbox"
                                                                                ...
                                                                                name="proWorking" id="proWorking">
                                                                            <label class="custom-control-label"
                                                                                for="proWorking">Currently Working? </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="buttons mb-5">
                                                <a href="javascript:void(0)" class="moreExperience cust_link">+ Add more
                                                    experience</a>
                                            </div>
                                            <div class="results"></div>
                                            <div class="row mt-1">
                                                <div class="col-md-12">
                                                    <button class="schedule-btn" id="professinal_btn"
                                                        style="width: 180px;float:right;font-size: 14px;" type="submit"
                                                        name="profession">Save Changes</button>
                                                    <button type="button" role="button" type="button"
                                                        id="professinal_loading" disabled class="btn btn-primary mb-4 mr-2"
                                                        style="width: 180px;float:right; display:none">
                                                        <i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"></i> <span
                                                            class="sr-only">Loading...</span> Processing </button>
                                                </div>
                                        ...
                                        <div class="accordion" id="accordionExample">
                                            <div class="">
                                                <div class="card-header" id="headingOne">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link btn-block text-left no-decoration"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row mt-3">
                                                                ...
                                                                <div class="col-md-5">
                                                                    ...
                                                                    <video id="video2" height="190" controls=""
                                                                        class="w-100 mt-2">
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingTwo">
                                                    <h2 class="mb-0">
                                                        <button
                                                            class="btn btn-link btn-block text-left collapsed no-decoration"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @elseif($tutor->status == 1)
                                                            <div class=" bg-toast infoCard" id="verfication_msg">
                                                                <div class="card-body row">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        Your Documents are under process. Please wait for
                                                                        Administrator approval
                                                                    </div>
                                                                    @foreach ($user_files as $files)
                                                                        <div class="col-md-6 mt-2 ">
                                                                            <input type="file"
                                                                                default-data="{{ asset($files->files) }}"
                                                                                class="dropify">
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                        ...
                                                        @else
                                                            ...
                                                            <form
                                                                ...
                                                                <div class=" row mt-3">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="exampleText"
                                                                            class="mb-0 heading-fifth">Document
                                                                            Number</label>
                                                                        <input id="textbox" type="text" name="document_no"
                                                                            placeholder="Document No" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6 mt-2 policeCert">
                                                                        <input type="file" name="policeCert_pic"
                                                                            class="dropify">
                                                                    </div>

                                                                    <div class="col-md-6 mt-2 id">
                                                                        <input type="file" name="id_card_pic"
                                                                            class="dropify">
                                                                    </div>
                                                                    <div class="col-md-6 mt-2 id">
                                                                        <input type="file" name="id_card_pic2"
                                                                            class="dropify">
                                                                    </div>
                                                                    <div class="col-md-6 mt-2 license">
                                                                        <input type="file" name="license_pic"
                                                                            class="dropify">
                                                                    </div>
                                                                    <div class="col-md-6 mt-2 license">
                                                                        <input type="file" name="license_pic2"
                                                                            class="dropify">
                                                                    </div>
                                                                    <div class="col-md-12 mt-2">
                                                                        <p>
                                                                            <strong>Kindly upload Card photos with white
                                                                                Background</strong>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row mt-3">
                                                                    <div class="col-md-12">
                                                                        <button class="schedule-btn" id="verfication_btn"
                                                                            style="width: 180px;float:right;font-size: 14px;"
                                                                            type="submit" name="personal">Save
                                                                            Changes</button>
                                                                        <button type="button" role="button" type="button"
                                                                            id="verfication_loading" disabled
    ...
    <div class="modal fade" id="sendFileVideo" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" role="button" type="button" id="uploadVid_loading" disabled
                        class="btn schedule-btn" style="display:none">
                        <i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"></i> <span
                            class="sr-only">Loading...</span> Processing </button>
                    <button type="button" class="btn cencel-btn" data-dismiss="modal">Cancel</button>
                </div>
                    ...
                    success: function(response) {
                        ...
                        if (response.status_code == 200 && response.success == true) {
                            ...
                            if (img_path != null && img_path != "") {
                                ...
                                $('.profile-img').attr('src', origin +
                                    '/assets/images/ico/Square-white.jpg');
                            }
