        ...
        init: function(options) {
            var p = {
                ...
                intro: { //Default intro settings
                    ...
                    title: 'Start Tour Of Tutorvy', //Title of introduction dialog
                    content: 'This tour will tell you about the tutorvy functionalities', //Content of introduction dialog
            ...
            if (!$.iGuider.opt) {
                ...
                var stepReplace = function(hStepItem) {
                    if (!hStepItem.loc) {
                        hStepItem.loc = $.iGuider.opt.loc || loc;
                    }
                                                                    ...
                                                                    if (checkNextFunc($($.iGuider.v.customTargetSelector)) === true) {
                                                                        ...
                                                                        if ($.iGuider.v.eventFlag == true) {
                                                                            ...
                                                                            $.iGuider.v.delayAfterId = setTimeout(function() {
                                                                                ...
                                                                                if ($.iGuider.v.nowLoc.search(escapeRe(targetLoc)) === -1 && targetLoc.search(escapeRe($.iGuider.v.nowLoc)) === -1 && $.iGuider.v.nowLoc !== targetLoc) {
